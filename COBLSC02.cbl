      ...
      ************************************************************
	   ...
	   FILE-CONTROL.
           ...
           SELECT BOAT-MASTER
               ASSIGN TO 'D:\IHCC\COBOL\COBLSC02\CBLBOAT1.DAT'
			   ORGANIZATION IS LINE SEQUENTIAL.

		   SELECT PRTOUT
			   ASSIGN TO 'D:\IHCC\COBOL\COBLSC02\BOATPRT.PRT'
      ...
      * READ IS CALLED BEFORE HEADINGS TO PRINT PAGE-COLUMN-HEADINGS-3 *
	   ...
	   2000-MAINLINE.
		   IF I-BOAT-TYPE NOT = H-BOAT-TYPE
			   ...
			   PERFORM 2010-COLUMN-HEADINGS-3.
		   PERFORM 2100-CALCS.
           PERFORM 2200-OUTPUT.
           PERFORM 9100-READ.

      * PRINTS BOAT TYPE LINE FOR EVERY CONTROL BREAK *
	   2010-COLUMN-HEADINGS-3.
      ...
      * CALLS MAJORSUBTOTALS TO FINISH CALCULATIONS *
	   3000-CLOSING.
		   PERFORM 9000-MAJORSUBTOTALS
